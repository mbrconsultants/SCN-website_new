                  ...
                  <div className="inner-box">
                    <div className="content-box">
                      <div className="title-box">
                        <h4 className="title">
                          <Link href={`/departments-details/${departments.ID}`}>
                            {departments.Title}
                          </Link>
                        </h4>
                      ...
                      <div className="text">
                        {stripHtmlTags(departments.Content).length > 60
                          ? stripHtmlTags(departments.Content).substring(
                              0,
                              80
                            ) + "..."
                      ...
                      <div className="btn-box">
                        <Link
                          href={`/departments-details/${departments.ID}`}
                          className="read-more">
                          Read More
                          <i className="btn-icon far fa-arrow-right"></i>
                        </Link>
                      </div>
                    </div>
                  </div>
