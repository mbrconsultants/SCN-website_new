                ...
                <div className="auto-container">
                    ...
                    {!loading &&
                        <div className="row">
                            {(acts && acts.length > 0) ?
                                acts.map((act, index) => (
                                <div className="pricing-block-two col-xl-8 col-lg-8 col-md-8 col-sm-12 wow fadeInUp" key={index}>
                                        ...
                                        <div className="content-box">
                                            <div>
                                                <figure className="image">
                                                    <Link href={act.file_path} target='_blank'><img src="images/resource/icon.jpg" alt="Image" style={{ height: '50px', width: '50px' }} /> </Link>
                                                </figure>
                                            </div>
