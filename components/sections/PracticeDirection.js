...
const ScnAct = () => {
    ...
    const fetchActs = async () => {
        try {
            const response = await endpoint.get('/practice-direction');
            ...
            <section className="pricing-section-two">
                <div className="auto-container">
                    <div className="sec-title text-center">
                        <h2 style={{ color: '#2BB584' }}>Practice Direction <span className="fa fa-legal"></span></h2>
                    </div>
                                    ...
                                    <div className="pricing-block-two col-xl-8 col-lg-8 col-md-8 col-sm-12 wow fadeInUp">
                                        <div className="inner-box">
                                            <div className="title-box">
                                                ...
                                                <div className="text">Click on the Pdf Icon below to download our practice direction.</div>

                                            </div>
                                            <div className="content-box">
                                                <div>
                                                    <figure className="image">
                                                    <Link href={act.file_path} target='_blank'>
