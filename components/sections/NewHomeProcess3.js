			...
			<Swiper {...swiperOptions} className="team-carousel owl-carousel owl-theme default-navs">
							...
							<SwiperSlide>
								<div className="process-block-three">
									<div className="inner-box" style={cardStyle2}>
										<div className="top-box">
											<div className="icon-box"></div>
                                            <h2 className="count" style={{ color: "#2BB584" }}><span className="fa fa-legal"></span></h2>
										</div>
										<h4 className="title" style={{ color: "#2BB584" }}><a href="">Chamber Sitting</a></h4>
										<div className="text">Review ongoing cases and legal proceedings scheduled for the Supreme Court's chamber sittings. </div>
