            ...
            <section className="project-section-twoo">
                <div className="large-container">
                    <div className="sec-title text-center">
                        ...
                        <h2 style={{ color: "" }}>Meet the justices of <br /> Supreme Court</h2>
                    </div>
                                            ...
                                            <SwiperSlide key={index}>
                                                <div className="project-block-two wow fadeInLeft">
                                                    <div className="inner-box" style={{
                                                        ...
                                                        borderTop: "4px solid #2BB584",  // Top left border
                                                        borderRight: "none",
                                                        borderBottom: "4px solid #2BB584", // Bottom right border
                                                        borderLeft: "none"
                                                    }}>
                                                        <div className="image-box" style={{ height: "450px" }}>
