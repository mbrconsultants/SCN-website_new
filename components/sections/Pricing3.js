                            ...
                            <div className="inner-box">
                                ...
                                <div className="content-box">
                                    ...
                                    <div className="btn-box">
                                        <Link href="page-pricing" className="theme-btn btn-style-two"><span className="btn-title">Purchase Now <i className="icon fa fa-arrow-right"></i></span></Link>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div className="pricing-block-two col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms">
                            <div className="inner-box">
                                <div className="title-box">
