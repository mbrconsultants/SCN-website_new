      ...
      <section className="pricing-section-two">
        <div className="auto-container">
          ...
          <div className="row">
            <div className="pricing-block-two col-xl-4 col-lg-4 col-md-4 col-sm-12 wow fadeInUp">
              <div className="inner-box">
                <div className="title-box">
                  <h4
                    className="title"
                    style={{ color: "#0EA476", fontSize: "30px" }}>
                    {" "}
            ...
            <div
              className="pricing-block-two col-xl-4 col-lg-4 col-md-4 col-sm-12 wow fadeInUp card shadow-lg"
              ...
              <div className="inner-box">
                <div className="title-box">
                  ...
                  <div className="text">
                    Watch live Supreme Court proceedings and stay informed on
                    critical legal matters in real-time.
                  </div>
                </div>
                <div className="content-box">
