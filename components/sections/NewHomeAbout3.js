            ...
            <section className="about-section-nine">
                <div className="auto-container">
                    <div className="row">
                        <div className="content-column col-lg-7 col-md-12 col-sm-12 wow fadeInLeft">
                            <div className="inner-column">
                                <div className="sec-title mb-4">
                                    ...
                                    <h5 style={{ color: "#2BB584" }}>{data.designation || "Designation"}</h5>
                                ...
                                <div className="row">
                                    <div className="info-box col-lg-6 col-md-6 col-sm-12 wow fadeInLeft">
                                        <div className="inner-box card shadow-lg">
                                            <div>
                                                <h4 className="count"><span className="fa fa-balance-scale"></span></h4>
                                                <h6 className="title">Our Mission</h6>
                                                <p className="title">To uphold justice, ensure the rule of law, and protect the rights of every citizen through impartial, transparent, and timely judgments.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="info-box col-lg-6 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="300ms">
                                        <div className="inner-box card shadow-lg">
                                            <div>
                                                <h4 className="count"><span className="fa fa-legal"></span></h4>
                                                <h6 className="title">Our Vision</h6>
                                                <p className="title">To be a beacon of justice, fostering a society where fairness and equity prevail, and the legal system serves all with integrity.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="image-column col-lg-5 wow fadeInRight" data-wow-delay="300ms">
