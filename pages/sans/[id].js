...
import SingleSanProfile from "@/components/sections/sanProfile";
...
const SanProfile = () => {
    ...
    const getData = async () => {
        try {
            const res = await endpoint.get(`/senior-advocates-of-nigeria/${id}`);
    ...
    return (
        <>
            <NewLayout3>
                ...
                <SingleSanProfile data={data} filePath={filePath} />
            </NewLayout3>
        </>
    );
};
